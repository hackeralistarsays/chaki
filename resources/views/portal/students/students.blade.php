...
<!-- Mirrored from thememakker.com/templates/oreo/university/html/students.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 13 Jun 2021 20:02:30 GMT -->
<head>
<meta charset="utf-8">
        ...
        <div class="row">
            ...
            <div class="col-lg-5 col-md-6 col-sm-12">
                ...
                <ul class="breadcrumb float-md-right">
                    <li class="breadcrumb-item"><a href=""><i class="zmdi zmdi-home"></i> Winterfel</a></li>
                    ...
                    <div class="body">
                        <div class="table-responsive">
                            <table class="table table-hover m-b-0">
                                ...
                                <tbody>
                                    <tr>
                                        <td><span class="list-icon"><img class="rounded" src="{{ asset('assets/assets/images/xs/avatar1.jpg') }}" alt=""></span></td>
                                    ...
                                    <tr>
                                        <td><span class="list-icon"><img class="rounded" src="{{ asset('assets/assets/images/xs/avatar2.jpg') }}" alt=""></span></td>
                                    ...
                                    <tr>
                                        <td><span class="list-icon"><img class="rounded" src="{{ asset('assets/assets/images/xs/avatar3.jpg') }}" alt=""></span></td>
                                    ...
                                    <tr>
                                        <td><span class="list-icon"><img class="rounded" src="{{ asset('assets/assets/images/xs/avatar4.jpg') }}" alt=""></span></td>
