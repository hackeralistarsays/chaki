...
<!-- Mirrored from thememakker.com/templates/oreo/university/html/events.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 13 Jun 2021 20:02:24 GMT -->
...
<head>
    ...
    <title>:: Oreo University Events ::</title>
    <link rel="icon" href="favicon.ico" type="image/x-icon">
    <!-- Favicon-->
    <link rel="stylesheet" href="{{ asset('assets/assets/plugins/bootstrap/css/bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/assets/plugins/fullcalendar/fullcalendar.min.css') }}">
    <!-- Custom Css -->
...
<body class="theme-blush">
    ...
    <script src="{{ asset('assets/assets/bundles/fullcalendarscripts.bundle.js') }}"></script>
    <!--/ calender javascripts -->

    <script src="{{ asset('assets/assets/bundles/mainscripts.bundle.js') }}"></script>
    <!-- Custom Js -->
    <script src="{{ asset('assets/assets/js/pages/calendar/calendar.js') }}"></script>
</body>

<!-- Mirrored from thememakker.com/templates/oreo/university/html/events.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 13 Jun 2021 20:02:26 GMT -->
