...
<!-- Mirrored from thememakker.com/templates/oreo/university/html/add-professors.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 13 Jun 2021 20:02:36 GMT -->
<head>
<meta charset="utf-8">
...
<script src="{{ asset('assets/assets/plugins/autosize/autosize.js') }}"></script> <!-- Autosize Plugin Js --> 
<script src="{{ asset('assets/assets/plugins/momentjs/moment.js') }}"></script> <!-- Moment Plugin Js --> 
