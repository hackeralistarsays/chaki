...
<!-- Mirrored from thememakker.com/templates/oreo/university/html/profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 13 Jun 2021 20:02:28 GMT -->
<head>
<meta charset="utf-8">
...
<link rel="stylesheet" href="{{ asset('assets/assets/css/timeline.css') }}">
            ...
            <div class="col-lg-4 col-md-12">
                <div class="card profile-header">
                    <div class="body text-center">
                        <div class="profile-image"> <img src="{{ asset('assets/assets/images/profile_av.jpg') }}" alt=""> </div>
                        <div>
                                ...
                                <div class="tab-pane body" id="friends">
                                    <ul class="new_friend_list list-unstyled row">
                                        <li class="col-lg-4 col-md-2 col-sm-6 col-4">
                                            <a href="#">
                                                <img src="{{ asset('assets/assets/images/sm/avatar1.jpg') }}" class="img-thumbnail" alt="User Image">
                                        ...
                                        <li class="col-lg-4 col-md-2 col-sm-6 col-4">
                                            <a href="#">
                                                <img src="{{ asset('assets/assets/images/sm/avatar2.jpg') }}" class="img-thumbnail" alt="User Image">
                                        ...
                                        <li class="col-lg-4 col-md-2 col-sm-6 col-4">
                                            <a href="#">
                                                <img src="{{ asset('assets/assets/images/sm/avatar3.jpg') }}" class="img-thumbnail" alt="User Image">
                                        ...
                                        <li class="col-lg-4 col-md-2 col-sm-6 col-4">
                                            <a href="#">
                                                <img src="{{ asset('assets/assets/images/sm/avatar4.jpg') }}" class="img-thumbnail" alt="User Image">
                                        ...
                                        <li class="col-lg-4 col-md-2 col-sm-6 col-4">
                                            <a href="#">
                                                <img src="{{ asset('assets/assets/images/sm/avatar5.jpg') }}" class="img-thumbnail" alt="User Image">
...
<script src="{{ asset('assets/assets/bundles/knob.bundle.js') }}"></script> <!-- Jquery Knob Plugin Js -->

<script src="{{ asset('assets/assets/bundles/mainscripts.bundle.js') }}"></script><!-- Custom Js -->
<script src="{{ asset('assets/assets/js/pages/charts/jquery-knob.js') }}"></script>
</body>

<!-- Mirrored from thememakker.com/templates/oreo/university/html/profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 13 Jun 2021 20:02:30 GMT -->
</html>