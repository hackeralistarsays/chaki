    ...
    <ul class="nav navbar-nav navbar-left">
        <li>
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/"><img src="{{ asset('assets/assets/images/logo.svg') }}" width="30" alt="Oreo"><span class="m-l-10">Oreo</span></a>
            </div>
        </li>
                            ...
                            <a href="javascript:void(0);">
                                <div class="progress-container progress-info">
                                    ...
                                    <ul class="list-unstyled team-info">
                                        <li class="m-r-15"><small class="text-muted">Team</small></li>
                                        <li>
                                            <img src="assets/assets/images/xs/avatar1.jpg" alt="Avatar">
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <img src="assets/assets/images/xs/avatar5.jpg" alt="Avatar">
                                        </li>
                                    </ul>
                                </div>
                            </a>
...
<aside id="leftsidebar" class="sidebar">
    <ul class="nav nav-tabs">
        ...
        <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#Inbox">Inbox</a></li>
    </ul>
    <div class="tab-content">
        <div class="tab-pane stretchRight" id="dashboard">
            <div class="menu">
                <ul class="list">
                    <li>
                        <div class="user-info">
                            <div class="image"><a href="/user/profile"><img src="{{ Auth()->user()->profile_photo_url }}" alt="{{ Auth()->user()->name }}"></a></div>
                            <div class="detail">
                    ...
                    <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-accounts-outline"></i><span>Students</span> </a>
                        <ul class="ml-menu">
                            <li><a href="/portal/students">All Students</a></li>
                            <li><a href="/portal/add_students">Add Students</a></li>                       
                            <li><a href="/portal/students_profile">Students Profile</a></li>
                            <li><a href="/portal/student_invoice">Students Invoice</a></li>
                        </ul>
                    </li>
                    <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-accounts-alt"></i><span>Professors</span> </a>
                        <ul class="ml-menu">
                            <li><a href="/portal/professors">All Professors</a></li>
                            <li><a href="/portal/add-professors">Add Professors</a></li>                       
                            <li><a href="/portal/profile">Profile</a></li>
                        </ul>
                    </li>
                    <li><a href="/portal/parents"><i class="zmdi zmdi-account"></i><span>Parents</span> </a></li>                    
                    ...
                    <li><a href="/portal/events"><i class="zmdi zmdi-calendar-check"></i><span>Events</span> </a></li>
                    <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-city-alt"></i><span>Departments</span> </a>
                        <ul class="ml-menu">
                            <li><a href="/portal/departments">All Departments</a></li>
                            <li><a href="/portal/add_department">Add Departments</a></li>
                        </ul>
                    </li>
                    <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-graduation-cap"></i><span>Courses</span> </a>
                        <ul class="ml-menu">
                            <li><a href="/portal/courses">All Courses</a></li>
                            <li><a href="/portal/add_course">Add Courses</a></li>                       
                            <li><a href="/portal/courses_info">Courses Info</a></li>
                        </ul>
                    </li>
                    <li><a href="/portal/library"><i class="zmdi zmdi-book"></i><span>Library</span> </a></li>
                    <li><a href="portal/classroom"><i class="zmdi zmdi-device-hub"></i><span>Class</span> </a></li>
                    <li><a href="/portal/noticeboard"><i class="zmdi zmdi-alert-circle"></i><span>Noticeboard</span> </a></li>
                    <li><a href="/portal/centres"><i class="zmdi zmdi-pin"></i><span>University Centres</span></a></li>
                    <li><a href="/portal/transport"><i class="zmdi zmdi-truck"></i><span>Transport</span></a></li>
                    <li><a href="/portal/hostel"><i class="zmdi zmdi-hotel"></i><span>Hostel List</span></a></li>                    
        ...
        <div class="tab-pane stretchLeft active" id="Inbox">
            <div class="menu">
                <ul class="list">
                    <li>
                        <div class="user-info m-b-20 p-b-15">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <small>Primary</small>
                                    <h5 class="m-b-5 number count-to" data-from="0" data-to="234" data-speed="2000" data-fresh-interval="700">234</h5>
                                </div>
                                <div class="col-6">
                                    <small>Updates</small>
                                    <h5 class="m-b-5 number count-to" data-from="0" data-to="705" data-speed="2000" data-fresh-interval="700">705</h5>
                                </div>
                            </div>
                        </div>
                    </li>
                    ...
                    <li>
                        <a href="/portal/compose" >
                            <i class="zmdi zmdi-plus-circle"></i>
                            <span>Compose Mail</span>
                        </a>
                    </li>
                    <li>
                        <a href="/portal/single" >
