                                ...
                                <div class="card" id="details">
                                    ...
                                    <div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-sm-6">
                                                <address>
                                                    ...
                                                    <h6>Department : {{$corse->department}}</h6>
                                                   @endforeach
                                                </address>
                                            </div>
                                            <div class="col-md-6 col-sm-6 text-right">
                                                ...
                                                @endforeach
                                                <p class="m-b-0"><strong>Status: </strong> <span class="badge bg-orange">@foreach($students as $student){{$student->status}}@endforeach</span></p>
                                            </div>
                                        </div>
                                        <div class="mt-40"></div>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            @csrf
                                            <button type="submit" class="btn btn-primary btn-round">Register Finance</button>
                                            </form>
                                            </div>
                                        </div>
                                        <hr>
