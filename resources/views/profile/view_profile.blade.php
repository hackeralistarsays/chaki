...
<div id="page-wrapper">
        <div id="page-inner">
            ...
            <a href="/users/profile/edit" style="float:right;"><button class="btn btn-primary">Edit profile</button></a>
            <div>
                                ...
                                <div class="row">
                                        <div class="row">
                                                <div class="col-xm-12 col-sm-6 col-md-12 col-lg-12 col-xl-12">
                                                        @if (Session::get('is_teacher') || Session::get('is_non_teaching_staff') || Session::get('is_student'))
