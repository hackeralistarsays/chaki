                                        ...
                                        <div class="form-group" id="category_div">
                                                ...
                                                <select id="category" name="category" class="form-control">
                                                    ...
                                                    <option  value="bursar" @if($category ?? '' == 'bursar') selected @endif>Bursar</option>
                                                     ...
                                                     <option value="nurse" @if($category ?? '' == 'nurse') selected @endif>School Nurse</option>
                                                     <option value="lab" @if($category ?? '' == 'lab') selected @endif>Lab Technician</option>
                                        ...
                                        <div class="form-group" id="nationality_div">
                                                ...
                                                <select id="nationality" name="nationality" class="form-control">
                                                    <option @if($nationality ?? '' == 'Kenyan') selected @endif>Kenyan</option>
                                                     ...
                                                     <option @if($nationality ?? '' == 'Tanzania') selected @endif>Tanzanian</option>
