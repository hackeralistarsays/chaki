...
<div class="wrapper">
    ...
    <section class="main-section">
            ...
            <div class="container">
                <div class="row">
                    <div class="section-title col-12">
                        <h2><span>PARENT'S </span>INFORMATION</h2>
                        <p>STUDENT'S PARENT/GUARDIAN DETAILS</p>
                    </div>
                </div>
                @if (count($errors) > 0)
              <div class="alert">
        ...
        @endif
                <form action="{{route('parents.application')}}" method = "POST" name="student_form" enctype="multipart/form-data">
                    @csrf
    <div >
        <div >
                ...
                <div style=" margin-left: 10px;">
                    ...
                    <div >
                      <div  class="row">
                            ...
                            <div class="col-xm-12 col-sm-12 col-md-6 col-lg-4 col-xl-4">
                                    <div class="form-group" id="middle_namer_div">
                                            <label for="middle_namer">MIDDLE NAME</label>
                            ...
                            <div class="col-xm-12 col-sm-12 col-md-6 col-lg-4 col-xl-4">
                                    <div class="form-group" id="id_number_div">
                                            ...
                                            <input type="number" id="id_number" class="form-control" name="id_number" placeholder="Enter ID number">
                            ...
                            <div class="col-xm-12 col-sm-12 col-md-6 col-lg-4 col-xl-4">
                                    <div class="form-group" id="occupation_div">
                                            ...
                                            <input type="text" id="occupation" class="form-control" name="occupation" placeholder="Enter Occupation">
