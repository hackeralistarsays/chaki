...
<div class="wrapper">
    ...
    <section class="main-section">
            ...
            <div class="container">
                <div class="row">
                    <div class="section-title col-12">
                        <h2><span>DOCUMENTS </span>UPLOAD</h2>
        ...
        @endif
                <form action="{{route('documents.application')}}" method = "POST" name="student_form" enctype="multipart/form-data">
                    @csrf
    <div >
        <div >
                    ...
                    <div >
                      <div  class="row">
                            ...
                            <div class="col-xm-12 col-sm-12 col-md-6 col-lg-4 col-xl-4">
                                  <div class="form-group" id="result_slip_div">
                                          <label class="control-table" for="result_slip">KCSE RESULT SLIP</label>
                                  <input type="file" name="result_slip" id="result_slip" class="form-control" placeholder="Upload Result slip">
                                          <div id="result_slip_error"></div>
                                  </div>	
                            </div>
      
    
                            <div class="col-xm-12 col-sm-12 col-md-6 col-lg-4 col-xl-4">
                                    <div class="form-group" id="copy_of_id_div">
                                            <label for="copy_of_id">COPY OF ID</label>
                                            <input type="file" name="copy_of_id" id="copy_of_id" class="form-control" placeholder="upload copy of ID" >
                                            <div id="copy_of_id_error"></div>
                                        </div>
                            ...
                            <div class="col-xm-12 col-sm-12 col-md-6 col-lg-4 col-xl-4">
                                    <div class="form-group" id="dob_div">
                                            <label for="living_cert">LIVING CERTIFICATE</label>
                                            <input type="file" id="living_cert" class="form-control" name="living_cert" value="{{$living_cert ?? ''}}">
                                            <input type="hidden" name="id" id="id" value="{{$id}}">
                                            <div id="living_cert_error"></div>
                                        </div>
                        ...
                        <div class="col-xm-3 col-sm-3 col-md-3 col-lg-3 col-xl-3 justify-content-between" >
                            <button type="submit" class="btn btn-success btn-round btn-block mt-4 m-b-0">FINISH</button>
