...
<head>
    ...
    <link href="{{ asset('oreo/assets/plugins/jquery-datatable/dataTables.bootstrap4.min.css" rel="stylesheet') }}">
    <!-- Custom Css -->
...
<body class="theme-blush">
   ...
   <!-- @include('portal.layouts.left-sidebar') -->
        ...
        <div class="container-fluid">
            <div class="row clearfix">
                <div class="col-md-12 col-lg-4">
                    <div class="card">
                        <div class="body">
                            <img src="{{ asset('oreo/assets/images/image1.jpg') }}" alt="" class="img-fluid rounded m-b-20">
                                ...
                                <div class="body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-sm-12">
                                            <img src="{{ asset('oreo/assets/images/image7.jpg') }}" alt="" class="img-fluid rounded m-b-30">
                                        </div>
                                        <div class="col-md-6 col-sm-12">
    ...
    <script src="{{ asset('oreo/assets/bundles/vendorscripts.bundle.js') }}"></script>
    <!-- Lib Scripts Plugin Js -->
