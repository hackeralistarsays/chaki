...
<!-- Mirrored from doccure-html.dreamguystech.com/template/pharmacy/add-product.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 14 May 2021 00:09:50 GMT -->
<head>
        <meta charset="utf-8">
        ...
        <!-- Fontawesome CSS -->
		<link rel="stylesheet" href="{{ asset('phamacy/plugins/fontawesome/css/fontawesome.min.css') }}">
		<link rel="stylesheet" href="{{ asset('phamacy/plugins/fontawesome/css/all.min.css') }}">

		<!-- Select2 CSS -->
		<link rel="stylesheet" href="{{ asset('phamacy/plugins/select2/css/select2.min.css') }}">
		
		<!-- Feathericon CSS -->
        <link rel="stylesheet" href="{{ asset('phamacy/css/feathericon.min.css') }}">
		
		<!-- Datatables CSS -->
		<link rel="stylesheet" href="{{ asset('phamacy/plugins/datatables/datatables.min.css') }}">
		
		<!-- Main CSS -->
        <link rel="stylesheet" href="{{ asset('phamacy/css/style.css') }}">
		
		<!--[if lt IE 9]>
			<script src="{{ asset('phamacy/js/html5shiv.min.js') }}"></script>
			<script src="{{ asset('phamacy/js/respond.min.js') }}"></script>
		<![endif]-->
    </head>
    <body>
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="card">
								...
								<!-- Add Medicine -->
								<form method="post" enctype="multipart/form-data" autocomplete="off" id="update_service" action="https://doccure-html.dreamguystech.com/template/pharmacy/medicine.html">
        ...
        <!-- Select2 JS -->
		<script src="{{ asset('phamacy/plugins/select2/js/select2.min.js') }}"></script>
		
		<!-- Slimscroll JS -->
        <script src="{{ asset('phamacy/plugins/slimscroll/jquery.slimscroll.min.js') }}"></script>
		
		<!-- Datatables JS -->
		<script src="{{ asset('phamacy/plugins/datatables/jquery.dataTables.min.js') }}"></script>
		<script src="{{ asset('phamacy/plugins/datatables/datatables.min.js') }}"></script>
