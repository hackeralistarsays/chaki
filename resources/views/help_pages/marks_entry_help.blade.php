...
<div class="panel panel-default w-auto">
    ...
    <br>
        ...
        <br>
        <img src="{{ URL::asset('help_images/add_marks.jpg') }}" alt="add marks" style=" margin-top: 10px; margin-bottom: 10px; height: auto; width: 90%;"/>
...
<div class="panel panel-default w-auto">
    ...
    <br>
          <p>A dialog modal pops up, as shown below, that displays the submitted marks and their respective comments appears.
           ...
           <br>
            <img src="{{ URL::asset('help_images/view_marks.jpg') }}" alt="view marks" style=" margin-top: 10px; margin-bottom: 10px; height: auto; width: 90%;"/>
...
<div class="panel panel-default w-auto">
    ...
    <br>
        ...
        not submitted any marks.
            ...
            <img src="{{ URL::asset('help_images/edit_marks.jpg') }}" alt="edit_marks" style=" margin-top: 10px; margin-bottom: 10px; height: auto; width: 90%;"/>
...
<div class="panel panel-default w-auto">
    ...
    <br>
        ...
        You can click the "close" button in changes you do not want to remove or delete the marks
            ...
            <img src="{{ URL::asset('help_images/remove_marks.jpg') }}" alt="edit_marks" style=" margin-top: 10px; margin-bottom: 10px; height: auto; width: 90%;"/>
