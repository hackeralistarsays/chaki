    ...
    <br>
        <div style="position: relative;">
           <p> The side menu will appear on the screen as shown below.</p>
            <img src="{{ URL::asset('help_images/show_side_menu.jpg') }}" alt="side menu" style="height: 400px;"/>
...
<div class="panel panel-default w-auto">
    ...
    <br>
        <div style="position: relative;">
           ...
           <br>
            <img src="{{ URL::asset('help_images/teachers_form.jpg') }}" alt="teachers form" style=" margin-top: 10px; margin-bottom: 10px; height: auto; width: 90%;"/>
...
<div class="panel panel-default w-auto">
    ...
    <br>
          <p> The the teachers details appear as follows. </p>
            <img src="{{ URL::asset('help_images/teachers_list.jpg') }}" alt="teachers list" style=" margin-top: 10px; margin-bottom: 10px; height: auto; width: 90%;"/>
