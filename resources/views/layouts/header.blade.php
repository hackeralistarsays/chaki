...
<!--<nav class="navbar navbar-expand-lg navbar-dark  navbar-fixed fixed-top ml-10" style="overflow: hidden; background-color: transparent;" >
        <a class="navbar-brand " href="#">EDEN SCHOOL</a>
      ...
      <nav class="navbar">
        <div class="max-width">
            <div class="logo ml-0"><a href="#"><span class="mr-20">EDEN </span>HIGH</a></div>
            <ul class="menu">
                <li><a href="#home" class="menu-btn">Home</a></li>
                <li><a href="#about" class="menu-btn">About</a></li>
                <li><a href="#services" class="menu-btn">Services</a></li>
                <li><a href="/signin" class="menu-btn">Login</a></li>
...
<footer class="page-footer font-small blue-grey lighten-5">
  ...
  <div class="container text-center text-md-left mt-5" style=" padding-top: 20px;" >
    ...
    <div class="row mt-3 dark-grey-text">
      ...
      <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
        ...
        <p>
          <i class="fas fa-envelope mr-3"></i> swinterfel@gmail.com.ke</p>
        <p>
          <i class="fas fa-phone mr-3"></i> + 254 740 096 095</p>
        <p>
          <i class="fas fa-print mr-3"></i> + 254 790 750 832</p>
  ...
  <div class="footer-copyright text-center text-black-50 py-3">© 2020 Copyright:
    <a class="dark-grey-text" href="#"> Winterfell High</a>
  </div>
  <!-- Copyright -->
