...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="/" class="brand-link">
      {{-- <img src="dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8"> --}}
      <strong>Winterfel University</strong>
    </a>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
               @php
                  ...
                  $daily = DB::table('admin_payment')->whereDate('created_at', Carbon::today())->count();
                  $weekly = DB::table('admin_payment')->whereBetween('created_at', [$weekStartDate, $today])->count();

                  $monthly = DB::table('admin_payment')->where('type', 'Monthly')->where('status','not-paid')->whereBetween('to', [$monthStartDate, $today])->count();




                  $yearly = DB::table('admin_payment')->whereBetween('created_at', [$yearStartDate, $today])->count();

                  $payment = DB::table('admin_payment')->where('status', 'paid')->whereBetween('created_at', [$weekStartDate, $today])->count();
               @endphp
          <!-- Add icons to the links using the .nav-icon class
               ...
               <li class="nav-item has-treeview">
                  ...
                  <i class="right fas fa-angle-right"></i>
                    ...
                    <ul class="nav nav-treeview">
                      ...
                      <li class="nav-item">
                        <a href="/admin/addStudent" class="nav-link">
                          <i class="fas fa-plus nav-icon"></i>
                          <p>Add Student</p>
                        </a>
                      </li>
                  ...
                  <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                      ...
                      <li class="nav-item">
                        <a href="/admin/payment-terms" class="nav-link">
               ...
               <li class="nav-item">
                ...
                @if (Session::get('staff_category') == "nurse")

                 <li class="nav-item">
                    <a href="/pharmacy" class="nav-link active">
                    <i class="nav-icon fas fa-tachometer-alt"></i>
                    <p>
                        Dashboard
                        <span class="right badge badge-danger"></span>
                ...
                @endif
                @endif
                <!-- Managing applicants and registration process -->
                @if(Session::get('is_in_examination_and_student_admission'))
                <li class="nav-item">
                        <a href="/registrar/dashboard" class="nav-link">
                          <i class="nav-icon fas fa-tachometer-alt"></i>
                          <p>
                            Dashboard
                            <span class="right badge badge-danger"></span>
                ...
                <li class="nav-item has-treeview">
                  ...
                  <ul class="nav nav-treeview">
                    <li class="nav-item">
                      <a href="/all_courses" class="nav-link">
                ...
                <li class="nav-item has-treeview">
                  ...
                  <ul class="nav nav-treeview">
                    <li class="nav-item">
                      <a href="/all_departments" class="nav-link">
                        <i class="fa-user-friends nav-icon"></i>
                        <p>All Departments</p>
                      </a>
                    </li>
                    <li class="nav-item">
 ...
 <!-- get the username-->
  ...
  <footer class="main-footer">
    <strong style="color: rgb(5, 157, 218)">Copyright &copy; 2021 <a href="#" style="color: rgb(169, 28, 28)">Winterfel University</a>.</strong>
    All rights reserved.
