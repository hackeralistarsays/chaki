        ...
        <div class="col-12">
          <nav class="main-nav">
            ...
            <a href="index.html" class="logo">
              <a href="/"><img src="{{asset('assets/images/logo/logo.jpeg')}}" style="width:10%;border-radius:70%;" ></a> 
            </a>
            ...
            <ul class="nav">
              ...
              <li class="scroll-to-section"><a href="/pharmacy">Dashboard</a></li> 

              @elseif (Session::get('is_principal') || Session::get('is_deputy_principal'))
              ...
              <li class="submenu">
                <a style="background-color: transparent" href="">Welcome {{Session::get('username')}}</a>
                <ul>
                ...
                @else 
                <li class="scroll-to-section"><div class="main-red-button"><a href="/signin">Login</a></div></li> 
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-12 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.25s">
              <p>© Copyright 2021 WinterFel High. All Rights Reserved. 
              
              <br>Design: <a rel="nofollow" href="">Winterfel High</a></p>
            </div>
          </div>
        </div>
      </footer>
